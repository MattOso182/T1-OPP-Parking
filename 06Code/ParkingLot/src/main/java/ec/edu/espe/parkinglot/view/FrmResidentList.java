...
private void addResidentActionPerformed(java.awt.event.ActionEvent evt) {                                            
    ...
    com.mongodb.client.MongoDatabase db = ec.edu.espe.parkinglot.utils.MongoConnection.getDatabase();
...
private void loadResidentData() {
    com.mongodb.client.MongoDatabase database = ec.edu.espe.parkinglot.utils.MongoConnection.getDatabase();
