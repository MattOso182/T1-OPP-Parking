...
public class ParkingStructure {
    ...
    public int getAvailableForRent() { return availableForRent; }
    public void setAvailableForRent(int availableForRent) { this.availableForRent = availableForRent; }
    
    public List<BuildingBlock> getBlocks() { return blocks; }
    public void setBlocks(List<BuildingBlock> blocks) { this.blocks = blocks; }
}
